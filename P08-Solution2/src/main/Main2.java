...
public class Main2 {
	...
	static Repeater r3vbg = new Repeater(3, bg); // The bar graph is displayed again, but now it will only be drawn every 3 votes (i.e. with the first, fourth, seventh, etc. votes)

	public static void main(String[] args) throws IOException {
		Question survey = new Question("Whay party are you going to vote in the next elections?", "pp", "psoe", "vox", "sumar");
